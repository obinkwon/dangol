...
<script type="text/javascript">
	function foodSort(page,type,anum){//페이지 이동
		location.href='foodSort.do?page='+page+'&type='+type+'&anum='+anum;
	}
</script>
<script type="text/javascript">
	$(document).ready(function(){
		$(".foodImg").click(function(){// 음식 종류 클릭시
			location.href="foodSort.do?type=new&anum="+$(this).children('input').val();
		});
		
		$("#sortSelect").change(function(){//정렬 클륵시
			var anum = $('#anum').val();
			location.href='foodSort.do?page=1&anum='+anum+'&type='+$(this).val();
		});
